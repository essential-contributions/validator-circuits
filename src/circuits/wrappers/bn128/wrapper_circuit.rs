...
impl BN128WrapperCircuit {
    ...
    pub fn generate_proof(
        ...
        inner_proof: &ProofWithPublicInputs<Field, Config, D>,
    ) -> Result<ProofWithPublicInputs<Field, PoseidonBN128GoldilocksConfig, D>> {
...
fn read_targets(buffer: &mut Buffer) -> IoResult<WrapperCircuitTargets> {
    ...
    Ok(WrapperCircuitTargets { verifier, proof })
}
